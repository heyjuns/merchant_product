...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SyncProductsEvent);
}
...
/// @nodoc
class $SyncProductsEventCopyWith<$Res>  {
$SyncProductsEventCopyWith(SyncProductsEvent _, $Res Function(SyncProductsEvent) __);
}


/// Adds pattern-matching-related methods to [SyncProductsEvent].
extension SyncProductsEventPatterns on SyncProductsEvent {
...
class _Started implements SyncProductsEvent {
  const _Started();
...
@override
String toString() {
  return 'SyncProductsEvent.started()';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SyncProductsState);
}
...
/// @nodoc
class $SyncProductsStateCopyWith<$Res>  {
$SyncProductsStateCopyWith(SyncProductsState _, $Res Function(SyncProductsState) __);
}


/// Adds pattern-matching-related methods to [SyncProductsState].
extension SyncProductsStatePatterns on SyncProductsState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements SyncProductsState {
  const _Initial();
...
@override
String toString() {
  return 'SyncProductsState.initial()';
}
...
class _Loading implements SyncProductsState {
  const _Loading();
...
@override
String toString() {
  return 'SyncProductsState.loading()';
}
...
class _Loaded implements SyncProductsState {
  const _Loaded();
...
@override
String toString() {
  return 'SyncProductsState.loaded()';
}
...
class _Failed implements SyncProductsState {
  const _Failed({required this.error});
  

 final  Failure error;

/// Create a copy of SyncProductsState
...
@override
String toString() {
  return 'SyncProductsState.failed(error: $error)';
}
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $SyncProductsStateCopyWith<$Res> {
