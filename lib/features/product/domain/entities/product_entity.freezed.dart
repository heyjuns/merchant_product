...
@override
String toString() {
  return 'ProductEntity(id: $id, name: $name, price: $price, description: $description, status: $status, updatedAt: $updatedAt)';
}
...
as ProductStatus,updatedAt: null == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
